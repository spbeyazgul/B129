...
//Bu array'deki tum sayilarin toplamini veren kodu yaziniz.
        ...
        for (int[] w : arr) {//[[2, 5, 1], [32, 75]]
            ...
            for (int k :w ) {//k artik array degil arrayin icindeki deger
                sum=sum+k;
        ...
        for (int [] w: brr) {//brr multidimansional arrayin icinden her bir w arrayini al
        ...
        for (int [] w : brr) {
            for (int k:w){//w arrayin icindeki her bir k degerini getir
