...
public class TypeCasting01 {
    ...
    public static void main(String[] args) {
        ...
        //Dikkat!
        // Donusum yaptiniz sayi (260) , donuseceginiz data type'inin sinirlari disinda ise, java kullandiginiz sayi ile
        // "mod" islemi yapar ve isleminin sonucu sizin degeriniz olur
        // Example1:
        short num =260;
