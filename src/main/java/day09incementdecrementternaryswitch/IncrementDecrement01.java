package day09incementdecrementternaryswitch;
...
public class IncrementDecrement01 {
    ...
    public static void main(String[] args) {
      ...
      a = a + 2;// veya a += 2;
        ...
        int k = i++;// post-increment cunku increment, variable'in islemşnden sonra yazildi.

        System.out.println(k);//10 ==> "i" artirilmadan "k" ya konuldugu icin "k" nin degeri 10 olur.
        System.out.println(i);//11 ==> "i" satir sonunda  getirildigi icin "i" nin degeri 11 olur.

        int m = 15;
        int n = ++m;// pro-increment cunku increment, variable'in islemşnden once yazildi.
