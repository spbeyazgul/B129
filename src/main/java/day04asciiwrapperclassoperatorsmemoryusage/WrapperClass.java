...
public class WrapperClass {
    ...
    public static void main(String[] args) {
     ...
     // Wrapper Class'lar non-primitive'dir o yuzden memory cok yer kaplarlar,o yuzden sart degilse Wrapper Class kullanmayi tercih etmeyiz.


     int n= 12; // "n" yazip nokta koyarsaniz hic method goremezsiniz, cunku primitiveler method icermezler
     ...
     // Example 1 : short data type'nin minimum ve maxımum degerlerini kod  yazarak bukunuz?
        ...
        System.out.println("intmax ve bytemin toplamı =" + intMin + byteMax);//-2147483648127
