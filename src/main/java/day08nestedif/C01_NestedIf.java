...
public class C01_NestedIf {
    ...
    /*
           TASK: Kullanicidan 3 tane pozitif bir tam sayi aliniz.
                 ...
                 Eger ucgen ise "eskenar ucgen olma durumunu kontrol edini.

                 INFO :
                 ucgen olma sarti : herhagi iki kenar toplami ucuncu kenarda buyuk olmalı
    ...
    public static void main(String[] args) {
      ...
      // Tum kenarlari birbirinden farkli ise "Cesitkenar Ucgen" yazdiriz.
